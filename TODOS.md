...
## Phase 2: LangChain and RAG
 ...
 - [ ] Sandbox: After 10 questions have the chatbot create a Google Books search engine query
    ...
    - [ ] Add another node to generate a list of 12 books as (title, author) to recommend
    - [ ] After 10 questions the LLM just lists it's final 12 book title and author. See if they are mostly real books.
